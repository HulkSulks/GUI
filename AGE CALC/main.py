...
if __name__ == "__main__" :
	...
	givenDate = Label(gui, text = "Current Date", bg = "blue")
	...
	givenDay = Label(gui, text = "Current Day", bg = "white")

	# Create a Given Month : label
	givenMonth = Label(gui, text = "Current Month", bg = "white")

	# Create a Given Year : label
	givenYear = Label(gui, text = "Cyrrent Year", bg = "white")
